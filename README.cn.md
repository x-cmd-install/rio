...
合计: **175,281** 行代码（覆盖前 5 种语言、共 **483** 个文件）。
...
- **上游仓库**: <https://github.com/raphamorim/rio>
- **官网**: <https://rioterm.com>
- **许可证**: MIT
...
- **Star**: 7,480 · **Fork**: 346 · **开放 issue**: 1,063 · **贡献者**: 139

## 累计统计

- **发布数**: 142 · **已合并 PR**: 525 · **开放 PR**: 92 · **已关闭 issue**: 857 · **开放 issue**: 206 · **提交数**: 4686

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-13 | 5 | 15 | 15 | 5 | 17 | 59 |
| last60d | 2026-07-14 | 27 | 74 | 44 | 23 | 43 | 358 |
| 90d | 2026-06-14 | 29 | 81 | 56 | 28 | 51 | 393 |
| last180d | 2026-03-16 | 49 | 111 | 76 | 107 | 90 | 854 |
| 360d | 2025-09-17 | 56 | 150 | 82 | 170 | 112 | 1155 |
| last720d | 2024-09-22 | 89 | 333 | 92 | 454 | 186 | 2181 |
...
rio 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `rio` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/rio.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T05:00:00Z._
